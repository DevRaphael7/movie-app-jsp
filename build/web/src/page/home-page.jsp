...
<html lang="pt-BR">
    ...
    <header class="home__page__header">
        <ul>
            <li>Terror</li>
            <li>Anime</li>
            <li>Luta</li>
        ...
        <div class="search__bar">
            ...
            <i class="fa-solid fa-magnifying-glass" style="padding-right: 2.5vh;"></i>
        </div>
    ...
    <section>
        <div class="filmes__destaque">
            ...
            <div id="row" style="justify-content: space-around; align-items: center;">
                ...
                <div class="img__card__big">
                    <img src="https://m.media-amazon.com/images/M/MV5BMGQ1ZGZmNTAtM2MyYi00NmZhLTkwYmYtNTNlZDRhMzU2ZTgwXkEyXkFqcGdeQW1yb3NzZXI@._V1_.jpg">
                    <div class="txt_box">
